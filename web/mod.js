...
export { SimpleValue as SimpleValue };
class TaggedValue {
...
export { TaggedValue as TaggedValue };
    ...
    switch (majorType) {
      ...
      case 5: {
        ...
        for (i = 0; i < length || length < 0 && !readBreak(); ++i) {
          const key = decodeItem();
          if (
            isStrict && Object.prototype.hasOwnProperty.call(retObject, key)
          ) {
            throw new Error("CBORError: Duplicate key encountered");
          }
...
export { CBOR as CBOR };
export { EMPTY_KEY as EMPTY_KEY, OMIT_VALUE as OMIT_VALUE };

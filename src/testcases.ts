...
export const testcases: any[][] = [
  ...
  ["Object {_ 'a': 1, 'b': [_ 2, 3]}", "bf61610161629f0203ffff", {
    a: 1,
    b: [2, 3],
  }, true],
  ["Object {_ 'Fun': true, 'Amt': -2}", "bf6346756ef563416d7421ff", {
    Fun: true,
    Amt: -2,
  }, true],
  ["false", "f4", false],
  ...
  [
    "Tagged 55799(0) (aka Self-describe CBOR)",
    "d9d9f700",
    new TestTaggedValue(0, 55799),
  ],
  [
    "Tagged 0xffffffff(0)",
    "db000000ffffffffff00",
    new TestTaggedValue(0, 0xffffffffff),
  ],
  ["Tagged 0xffffffff(0)", "daffffffff00", new TestTaggedValue(0, 0xffffffff)],
  ["Tagged 25(0)", "d81900", new TestTaggedValue(0, 25)],
  [
    'Tagged 0("2020-09-20T00:11:24.937Z") (aka iso date)',
    "c07818323032302d30392d32305430303a31313a32342e3933375a",
    new TestTaggedValue("2020-09-20T00:11:24.937Z", 0),
  ],
  [
    "Tagged 1(1600560146.876) (aka fractional date)",
    "c1fb41d7d9a704b81062",
    new TestTaggedValue(1600560146.876, 1),
  ],
  [
    "Tagged 1(1600560146) (aka integer date)",
    "c11a5f669c12",
    new TestTaggedValue(1600560146, 1),
  ],
  ...
  [
    "Uint32Array",
    "d8465001000000020000000000010004000000",
    new Uint32Array([1, 2, 65536, 4]),
  ],
  [
    "Int32Array",
    "d84e50010000000200000000000100fcffffff",
    new Int32Array([1, 2, 65536, -4]),
  ],
  [
    "Float32Array",
    "d855500000803f000000400000a03f0000a0bf",
    new Float32Array([1, 2, 1.25, -1.25]),
  ],
  [
    "Float64Array",
